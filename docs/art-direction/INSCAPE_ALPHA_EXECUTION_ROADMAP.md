...
Status: `[~]` — **Phase 5A and Phase 5B.1–5B.5 accepted; production category authoring awaits interactive acceptance; Phase 5B.6 onward remains unstarted**
...
Explicit exclusions: PORTALS or lattice launchers, drag-and-drop, bulk/multi-select, AI categorization, category artwork, favorites editing, legacy `AssetIndex` routing or cleanup, category publication/visitor navigation, wallet or IPFS writes, canonical lattice/schema/publication/viewer changes, and Phase 5B.6 presentation tools.
