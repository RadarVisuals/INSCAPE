...
export function createProfileDocumentState(snapshot = null, profileAddress = snapshot?.profile?.address || null) { return { profileAddress, snapshot, snapshotDraftFingerprint: null, snapshotGeneration: 0, imported: null, preview: null, previewSource: null, error: null }; }
export function activateProfileDocumentState(state, profileAddress) { return state.profileAddress === profileAddress ? state : createProfileDocumentState(null, profileAddress); }
