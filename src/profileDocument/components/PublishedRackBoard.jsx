...
export default function PublishedRackBoard({ identityRack, inventoryRack }) {
  return <section className="published-rack-board" aria-label="Published profile racks">
    <div className="published-rack-column published-rack-column--primary">
      {identityRack && <div className="published-rack-slot published-rack-slot--identity"><PublishedIdentityRack rack={identityRack} /></div>}
    </div>
