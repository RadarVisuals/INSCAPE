...
export default function AssetGrid({ assets, workspace, onSelect, onFavorite, onFolder, onCreateFolder, emptyMessage, emptyAction, authoringEnabled = false }) {
  ...
  return <div className="asset-grid">{assets.map((asset) => <AssetCard key={asset.id} asset={asset}
    ...
    onCreateFolder={onCreateFolder} authoringEnabled={authoringEnabled} />)}</div>;
}
