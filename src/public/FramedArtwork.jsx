export default function FramedArtwork({ object, asset, style, arranging, selected, compact, editable = false, onActivate, onEdit, containerRef, interactionProps = {}, resizeProps = {} }) {
