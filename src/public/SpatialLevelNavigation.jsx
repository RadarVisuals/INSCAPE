...
export default function SpatialLevelNavigation({ level = SPATIAL_WORLD_LEVEL.HOME, disabled = false, onUp, onDown }) {
  ...
  return <nav className="spatial-level-navigation" aria-label="Spatial level navigation" data-disabled={disabled || undefined}>
