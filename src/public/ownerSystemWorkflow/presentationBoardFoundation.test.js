...
test('owner Display Module reuses the existing interactive canvas inside one clipped Stage', () => {
  ...
  assert.match(styles, /\.system-workflow__metadata-sidecar-shell \{[^}]*left: calc\(100% \+ var\(--workflow-board-frame-gap\)\);[^}]*width: calc\(var\(--workflow-metadata-width, 286px\) - var\(--workflow-board-frame-gap\)\);[^}]*height: calc\(100% \+ var\(--workflow-board-frame-gap\)\);/s);
  assert.match(styles, /\.system-workflow__metadata-projection\.is-side \{[^}]*top: var\(--workflow-identity-strip-height\);[^}]*bottom: var\(--workflow-board-frame-gap\);[^}]*left: 0;[^}]*width: 100%;[^}]*height: auto;[^}]*max-height: none;[^}]*overflow: hidden;/s);
  assert.match(styles, /\.system-workflow__metadata-side-scroll \{[^}]*height: 100%;[^}]*min-height: 0;[^}]*overflow: hidden;[^}]*clip-path: inset\(0 round var\(--workflow-board-radius\)\);/s);
  assert.match(styles, /\.system-workflow__metadata-projection\.is-side \.system-workflow__metadata-module-content \{[^}]*height: 100%;[^}]*align-content: start;[^}]*grid-auto-rows: max-content;[^}]*overflow-y: auto;/s);
  assert.match(styles, /\.system-workflow__metadata-projection\.is-side::\-webkit-scrollbar,[\s\S]*?\.system-workflow__metadata-side-scroll::\-webkit-scrollbar \{[^}]*display: none;/s);
  ...
  assert.match(styles, /\.system-workflow__metadata-projection\.is-down \{[^}]*width: 100%;[^}]*max-height: 60%;[^}]*padding: 0 0 var\(--workflow-board-frame-gap\) var\(--workflow-board-frame-gap\);[^}]*overflow: hidden;/s);
  ...
  assert.match(styles, /\.system-workflow__metadata-projection\.is-down \.system-workflow__metadata-module-content \{[^}]*padding: calc\(14px \+ var\(--workflow-board-frame-gap\)\) 12px 11px;[^}]*gap: 0;[^}]*border-radius: var\(--workflow-board-radius\);[^}]*background: var\(--workflow-panel\);/s);
  assert.match(styles, /\.system-workflow__metadata-projection\.is-down \.system-workflow__metadata-module-content > section,[\s\S]*?min-height: 0;/s);
