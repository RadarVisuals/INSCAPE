...
const WORKSPACE_TOOLS = Object.freeze([
  { id: 'browser', label: 'BROWSER', disabled: true, disabledReason: 'Browser integration is not available in Phase 4' },
  ...
  >
    ...
    {interfaceVisible && <>
      ...
      <LatticeWorkspaceToolbar
        activeToolId={themeOpen ? 'theme' : null}
        compact={dimensions.width <= 980}
        owner
        tools={WORKSPACE_TOOLS}
        onEscape={() => setThemeOpen(false)}
        onToolActivate={(toolId) => {
          if (toolId === 'theme') setThemeOpen((open) => !open);
        }}
      />
